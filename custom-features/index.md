...
In addition to [features](../features-overview/) that are available in Koog out of the box, you can also implement your own features by extending a proper feature interface. This page presents the basic building blocks for your own feature using the current Koog APIs.
...
An example of a feature that relies on processing the entire agent event stream is [OpenTelemetry](../opentelemetry-support/), as it uses the complete agent event structure to compose an inherited structure of spans.
